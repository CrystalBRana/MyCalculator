...
num_1 = Button(root, font=font, bd="16", text="1", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(1))
num_2 = Button(root, font=font, bd="16", text="2", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(2))
num_3 = Button(root, font=font, bd="16", text="3", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(3))
num_4 = Button(root, font=font, bd="16", text="4", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(4))
num_5 = Button(root, font=font, bd="16", text="5", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(5))
num_6 = Button(root, font=font, bd="16", text="6", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(6))
num_7 = Button(root, font=font, bd="16", text="7", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(7))
num_8 = Button(root, font=font, bd="16", text="8", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(8))
num_9 = Button(root, font=font, bd="16", text="9", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(9))
num_0 = Button(root, font=font, bd="16", text="0", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button(0))
...
dot_B = Button(root, font=font, bd="16", text=".", padx=20, pady=18, fg="red", bg="sky blue", command=lambda: num_button("."))
